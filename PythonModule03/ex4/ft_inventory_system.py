...
if __name__ == '__main__':
    ...
    print(f"Item sword represents: {inventory['sword'] / sum(inventory.values()) * 100:.1f}%")
    print(f"Item sword represents: {inventory['potion'] / sum(inventory.values()) * 100:.1f}%")
    print(f"Item shield represents: {inventory['shield'] / sum(inventory.values()) * 100:.1f}%")
    print(f"Item armor represents: {inventory['armor'] / sum(inventory.values()) * 100:.1f}%")
    print(f"Item helmet represents: {inventory['helmet'] / sum(inventory.values()) * 100:.1f}%")
    most = None
